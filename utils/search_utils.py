...
from utils.feature_utils import ResnetFeatureGenerator, AkiwiFeatureGenerator
...
class Search():
    ...
    def get_similar_images_with_distances(self, img: Image, num_imgs=8, metric='l1'):
        ...
        :return: best image paths and their distances to the original image
        """
...
class CombinedSearch():
    ...
    def __init__(self, search_list, factors=None):
        ...
        :param factors: list of factors to multiply the respective Search features
        """
